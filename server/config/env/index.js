...
var all = {
  ...
  //默认首页图片.
  defaultIndexImage:
    "https://upload.jackhu.top/blog/index/default.jpg-600x1500q80",
  //第三方登录配置
  github: {
  ...
  apps: [
    {
      ...
      qrcode:
        "https://upload.jackhu.top/qrcode/jackblog-react-native-qrcode.png",
    },
    {
      name: "Ionic 2.0",
      ...
      downloadUrl: {
        android:
          "https://upload.jackhu.top/downloads/Jackblog-ionic2-1.0.0.apk",
        ios: "",
      },
...
if (fs.existsSync(path.join(__dirname, "private/index.js"))) {
  config = _.merge(
    config,
    require(path.join(__dirname, "private/index.js")) || {}
  );
}
